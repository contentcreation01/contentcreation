# Deep Content Analysis: chandlerintelligence - Video by chandlerintelligence

## 1. Performance Snapshot
- **Platform**: Instagram (Reels)
- **Channel / Creator**: @chandlerintelligence
- **Shortcode / ID**: `DaebyH0xIDQ`
- **Source URL**: https://www.instagram.com/reel/DaebyH0xIDQ/
- **Views**: N/A
- **Likes**: 271,174
- **Comments**: 42,638
- **Duration**: 0.0 seconds | **Upload Date**: 20260707

---

## 2. Pacing & Retention Metrics
- **Speaking Rate**: `313 Words Per Minute (WPM)`
- **Cadence Verdict**: ⚡ Hyper-Fast / High-Retention (170+ WPM)
- **Visual Editing Cuts**: 1 jump cuts (avg 1 cut every 0.0s)
- **Editing Rule**: You must cut the video every ~0.0 seconds to match retention.
...
## 5. Pre-Flight Hook Retention Score (F-Tier: 38/100)
- **Opening Hook**: "Hey Jarvis, wake up daddy song. How's the app doing?"
- **Retention Verdict**: Fluff Alert (Imminent Swipe-Away)
- **Cadence & Brevity**: 20/20 pts (10 words)
- **Tension & Interrupt**: 8/25 pts
- **Visual Action Cues**: 0/20 pts
- **Open Loop & Curiosity**: 5/20 pts
- **Stakes & Audience Relevance**: 5/15 pts
